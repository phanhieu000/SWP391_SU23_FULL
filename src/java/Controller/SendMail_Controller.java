 ...
 * @author phanh
 */
@WebServlet(name="SendMail_Controller", urlPatterns={"/sendMail"})
public class SendMail_Controller extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SendMail_Controller</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SendMail_Controller at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//        System.out.println("Verification code: " + uuid);
        ...
        final String password = "rmqeguieyxijmxmdh";
