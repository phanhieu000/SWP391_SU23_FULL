        ...
        <div class="container">
            <div class="row">
                ...
                <aside class="col-md-4 widget widget_gallery">
                    ...
                    <ul>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-1.jpg" alt=""></a></li>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-2.jpg" alt=""></a></li>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-3.jpg" alt=""></a></li>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-4.jpg" alt=""></a></li>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-5.jpg" alt=""></a></li>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-6.jpg" alt=""></a></li>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-7.jpg" alt=""></a></li>
                        <li><a data-fancybox-group="group" href="views/extra-images/widget-gallery-1.jpg" class="fancybox"><img src="views/extra-images/widget-gallery-8.jpg" alt=""></a></li>
                    </ul>
                </aside>
                <!--// Widget Gallery \\-->
