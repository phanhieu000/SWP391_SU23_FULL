...
<script >
    ...
    function checkOldPassword() {
        ...
        if (oldPassMD5 !== currentPass) {
            ...
            message.innerHTML = 'M?t Kh?u C? Không ?úng !';
    ...
    function checkNewPassword() {
        ...
        if (newPass.value === currentPass) {
            ...
            message.innerHTML = 'M?t Kh?u M?i Không ???c Trùng V?i M?t Kh?u C? ';
            message.style.color = 'red';
            return false;
    ...
    function checkComfirmPassword() {
        ...
        if (newPass.value !== confirmPass.value) {
            ...
            message.innerHTML = 'M?t Kh?u Comfirm Không Gi?ng M?t Kh?u M?i ';
            message.style.color = 'red';
            return false;
